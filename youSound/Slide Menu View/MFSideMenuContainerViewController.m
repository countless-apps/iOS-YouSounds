...
- (void)openRightSideMenuCompletion:(void (^)(void))completion {
    ...
    [self setCenterViewControllerOffset:0*self.rightMenuWidth animated:YES completion:completion];
}
...
- (void) setLeftSideMenuFrameToClosedPosition {
    ...
    leftFrame.origin.x = (self.menuSlideAnimationEnabled) ? 0*leftFrame.size.width / self.menuSlideAnimationFactor : 0;
